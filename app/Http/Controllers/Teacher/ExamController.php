...
{
    // Bắt đầu truy vấn và chỉ lọc những đề thi do chính giáo viên này tạo 
    $query = \App\Models\Exam::with('creator');

    // Xử lý tìm kiếm theo tiêu đề hoặc mô tả nếu người dùng nhập từ khóa
    ...
    // Lấy dữ liệu, sắp xếp mới nhất và phân trang 10 mục 
...
public function edit($id)
{
    ...
    public function destroy($id)
    {
        ...
        $exam->delete();
        return redirect()->back()->with('success', 'Đề thi đã được xóa thành công.');
    }
}