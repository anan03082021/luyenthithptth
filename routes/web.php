...
/*
|--------------------------------------------------------------------------
| CÁC ROUTE DÙNG CHUNG (CẢ GV VÀ HS ĐỀU VÀO ĐƯỢC)
|--------------------------------------------------------------------------
*/
Route::middleware('auth')->group(function () {
    // Di chuyển 3 dòng này ra khỏi nhóm 'role:student'
...
Route::get('/teacher/sessions/{id}/recalculate', [App\Http\Controllers\Teacher\ExamSessionController::class, 'recalculateScores'])
    ->name('teacher.sessions.recalculate');
    });
